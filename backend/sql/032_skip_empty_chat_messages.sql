-- Evita inserir linhas vazias em crm_chat_messages para eventos sem conteudo
-- e sem midia (ex: messages.update, webhooks mal formatados).
-- Consolida a funcao fn_sync_communication_event com o guard.

-- Corrige a trigger fn_sync_communication_event que foi sobrescrita
-- pela migracao 032 com ON CONFLICT (document_key, whatsapp_instance) em
-- crm_chat_conversations, porem nao existe UNIQUE constraint nessas colunas.
--
-- Restaura o padrao SELECT-then-UPDATE-or-INSERT da migracao 031 e adiciona
-- o guard para nao inserir mensagens vazias sem midia.
